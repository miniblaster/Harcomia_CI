            ...
            <div class="row mb-4 d-print-none">
                ...
                <div class="col-12 col-lg-6 mb-3 mb-lg-0 dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="<?= $data->values['data'] ?? ASSETS_FULL_URL . 'images/qr_code.svg' ?>" id="download_svg" class="dropdown-item" download="<?= get_slug($data->values['name'] ?? settings()->main->title) . '.svg' ?>"><?= sprintf(l('global.download_as'), 'SVG') ?></a>
