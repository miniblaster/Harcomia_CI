...
<div class="container">
    ...
    <nav aria-label="breadcrumb">
        <ol class="custom-breadcrumbs small">
            ...
            <li class="active" aria-current="page"><?= l('tools.jpg_to_webp.name') ?></li>
        </ol>
    </nav>

    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.jpg_to_webp.name') ?></h1>

            <div class="ml-2">
                <span data-toggle="tooltip" title="<?= l('tools.jpg_to_webp.description') ?>">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <label for="result"><?= l('tools.jpg_to_webp.result') ?></label>
                    <div>
                        <a
                                href=""
                                target="_blank"
                                ...
                                download="<?= l('tools.jpg_to_webp.result') . '.webp' ?>"
                                id="download"
                        >
