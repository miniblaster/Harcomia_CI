...
<div class="container">
    ...
    <div class="row mb-4">
        <div class="col-12 col-xl d-flex align-items-center mb-3 mb-xl-0">
            <h1 class="h4 m-0"><?= l('tools.signature_generator.name') ?></h1>
    ...
    <div class="row">
        <div class="col-12">
            <canvas id="canvas" class="custom-row p-0" width="1106" height="500"></canvas>
        </div>
    </div>

    <div class="mt-3">
        <input id="color" type="color" name="color" class="form-control" value="#000000" />
    </div>

    <div class="row mt-3">
        <div class="col-3 mb-3">
            <button id="clear" type="button" class="btn btn-block btn-outline-secondary">
                <i class="fa fa-fw fa-sm fa-eraser"></i> <?= l('tools.signature_generator.clear') ?>
            </button>
        </div>

        <div class="col-3 mb-3">
            <button id="undo" type="button" class="btn btn-block btn-outline-secondary">
                <i class="fa fa-fw fa-sm fa-undo"></i> <?= l('tools.signature_generator.undo') ?>
            </button>
        </div>
