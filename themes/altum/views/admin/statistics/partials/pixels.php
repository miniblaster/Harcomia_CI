...
<div class="card mb-5">
    <div class="card-body">
        <h2 class="h4"><i class="fa fa-fw fa-adjust fa-xs text-muted"></i> <?= l('admin_statistics.pixels.header') ?></h2>
        <div class="d-flex flex-column flex-xl-row">
            <div class="mb-2 mb-xl-0 mr-4">
                <span class="font-weight-bold"><?= nr($data->total['pixels']) ?></span> <?= l('admin_statistics.pixels.chart') ?>
            </div>
        </div>
