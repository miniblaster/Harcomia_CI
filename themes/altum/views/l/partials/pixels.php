...
<?php foreach($data->pixels as $pixel): ?>
    ...
    <?php if($pixel->type == 'facebook'): ?>
        <script <?= settings()->cookie_consent->is_enabled && $data->type == 'biolink' ? 'type="text/plain" data-cookiecategory="targeting"' : null ?>>
    ...
    <?php if($pixel->type == 'google_analytics'): ?>
        <script async src="https://www.googletagmanager.com/gtag/js?id=<?= $pixel->pixel ?>" <?= settings()->cookie_consent->is_enabled && $data->type == 'biolink' ? 'type="text/plain" data-cookiecategory="analytics"' : null ?>></script>
        <script <?= settings()->cookie_consent->is_enabled && $data->type == 'biolink' ? 'type="text/plain" data-cookiecategory="analytics"' : null ?>>
