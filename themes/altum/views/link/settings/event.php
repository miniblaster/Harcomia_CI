...
<div class="card">
    <div class="card-body">
        ...
        <form name="update_event" action="" method="post" role="form">
            ...
            <div class="form-group">
                <label for="<?= 'event_name_' . $data->link->link_id ?>"><i class="fa fa-fw fa-signature fa-sm text-muted mr-1"></i> <?= l('create_event_modal.input.event_name') ?></label>
                <input type="text" id="<?= 'event_name_' . $data->link->link_id ?>" name="event_name" class="form-control" value="<?= $data->link->settings->event_name ?? null ?>" maxlength="<?= $data->link_types['event']['fields']['name']['max_length'] ?>" />
            </div>

            <div class="form-group">
                <label for="<?= 'event_location_' . $data->link->link_id ?>"><i class="fa fa-fw fa-map-pin fa-sm text-muted mr-1"></i> <?= l('create_event_modal.input.event_location') ?></label>
                <input type="text" id="<?= 'event_location_' . $data->link->link_id ?>" name="event_location" class="form-control" value="<?= $data->link->settings->event_location ?? null ?>" maxlength="<?= $data->link_types['event']['fields']['location']['max_length'] ?>" />
            </div>

            <div class="form-group">
                <label for="<?= 'event_url_' . $data->link->link_id ?>"><i class="fa fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('create_event_modal.input.event_url') ?></label>
                <input type="url" id="<?= 'event_url_' . $data->link->link_id ?>" name="event_url" class="form-control" value="<?= $data->link->settings->event_url ?? null ?>" maxlength="<?= $data->link_types['event']['fields']['url']['max_length'] ?>" />
            </div>

            <div class="form-group">
                <label for="<?= 'event_note_' . $data->link->link_id ?>"><i class="fa fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('create_event_modal.input.event_note') ?></label>
                <textarea id="<?= 'event_note_' . $data->link->link_id ?>" name="event_note" class="form-control" maxlength="<?= $data->link_types['event']['fields']['note']['max_length'] ?>"><?= $data->link->settings->event_note ?? null ?></textarea>
            </div>

            <div class="form-group">
                <label for="<?= 'event_start_datetime_' . $data->link->link_id ?>"><i class="fa fa-fw fa-calendar fa-sm text-muted mr-1"></i> <?= l('create_event_modal.input.event_start_datetime') ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'event_end_datetime_' . $data->link->link_id ?>"><i class="fa fa-fw fa-calendar fa-sm text-muted mr-1"></i> <?= l('create_event_modal.input.event_end_datetime') ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'event_timezone_' . $data->link->link_id ?>"><i class="fa fa-fw fa-atlas fa-sm text-muted mr-1"></i> <?= l('create_event_modal.input.event_timezone') ?></label>
