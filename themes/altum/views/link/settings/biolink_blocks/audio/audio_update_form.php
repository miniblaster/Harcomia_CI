...
<form name="update_biolink_" method="post" role="form" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input id="<?= 'audio_file_' . $row->biolink_block_id ?>" type="file" name="file" accept="<?= \Altum\Uploads::array_to_list_format($data->biolink_blocks['audio']['whitelisted_file_extensions']) ?>" class="form-control-file altum-file-input" />
