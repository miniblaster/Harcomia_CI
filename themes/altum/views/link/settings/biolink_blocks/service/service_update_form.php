...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="collapse" id="<?= 'service_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            ...
            <input type="text" id="<?= 'service_title_' . $row->biolink_block_id ?>" name="title" class="form-control" value="<?= $row->settings->title ?? null ?>" maxlength="<?= $data->biolink_blocks['service']['fields']['title']['max_length'] ?>" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'service_description_' . $row->biolink_block_id ?>"><?= l('create_biolink_service_modal.description') ?></label>
            <input type="text" id="<?= 'service_description_' . $row->biolink_block_id ?>" name="description" class="form-control" value="<?= $row->settings->description ?? null ?>" maxlength="<?= $data->biolink_blocks['service']['fields']['description']['max_length'] ?>" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'service_price_' . $row->biolink_block_id ?>"><?= l('create_biolink_service_modal.price') ?></label>
            <input type="number" min="0" step="0.01" id="<?= 'service_price_' . $row->biolink_block_id ?>" name="price" class="form-control" value="<?= $row->settings->price ?? null ?>" required="required" />
        </div>

        <div class="form-group">
            <label for="<?= 'service_currency_' . $row->biolink_block_id ?>"><?= l('create_biolink_service_modal.currency') ?></label>
            <input type="text" id="<?= 'service_currency_' . $row->biolink_block_id ?>" name="currency" class="form-control" value="<?= $row->settings->currency ?? null ?>" maxlength="<?= $data->biolink_blocks['service']['fields']['currency']['max_length'] ?>" required="required" />
    ...
    <div class="collapse" id="<?= 'button_settings_container_' . $row->biolink_block_id ?>">
        ...
        <div class="form-group">
            ...
            <input id="<?= 'service_image_' . $row->biolink_block_id ?>" type="file" name="image" accept="<?= \Altum\Uploads::array_to_list_format($data->biolink_blocks['service']['whitelisted_thumbnail_image_extensions']) ?>" class="form-control-file altum-file-input" />
        ...
        <div <?= $this->user->plan_settings->custom_colored_links ? null : 'data-toggle="tooltip" title="' . l('global.info_message.plan_feature_no_access') . '"' ?>>
            <div class="<?= $this->user->plan_settings->custom_colored_links ? null : 'container-disabled' ?>">
                ...
                <div class="form-group">
                    <label for="<?= 'service_text_alignment_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-align-center fa-sm text-muted mr-1"></i> <?= l('create_biolink_link_modal.input.text_alignment') ?></label>
                    <select id="<?= 'service_text_alignment_' . $row->biolink_block_id ?>" name="text_alignment" class="form-control">
