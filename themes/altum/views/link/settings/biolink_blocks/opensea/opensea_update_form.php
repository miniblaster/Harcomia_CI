...
<form name="update_biolink_" method="post" role="form">
    ...
    <div class="form-group">
        <label for="<?= 'opensea_token_address_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-passport fa-sm text-muted mr-1"></i> <?= l('create_biolink_opensea_modal.token_address') ?></label>
        <input id="<?= 'opensea_token_address_' . $row->biolink_block_id ?>" type="text" class="form-control" name="token_address" value="<?= $row->settings->token_address ?>" required="required" maxlength="128" />
    </div>

    <div class="form-group">
        <label for="<?= 'opensea_token_id_' . $row->biolink_block_id ?>"><i class="fa fa-fw fa-id-card fa-sm text-muted mr-1"></i> <?= l('create_biolink_opensea_modal.token_id') ?></label>
        <input id="<?= 'opensea_token_id_' . $row->biolink_block_id ?>" type="number" step="1" class="form-control" name="token_id" value="<?= $row->settings->token_id ?>" required="required" />
    </div>
